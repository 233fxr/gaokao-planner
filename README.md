...
| 文件 | 说明 |
|------|------|
| `chemistry.json` | 化学一轮复习知识点，47 个专题，133 个考点（含 phase1/phase2 两轮结构） |
| `physics.json` | 物理一轮复习知识点，33 个专题，158 个考点（含 phase1/phase2 两轮结构） |
| `processed_files.json` | 已处理课件文件元数据（34 个文件） |
